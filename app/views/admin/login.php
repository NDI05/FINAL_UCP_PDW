...
<body class="bg-[#0a0a0a] text-white font-display min-h-screen flex items-center justify-center px-6">
    <div class="w-full max-w-sm border border-[#333] p-8">
        ...
        <form method="POST" action="/admin/login" class="space-y-5">
            <div><label for="username" class="block text-[10px] font-mono text-[#666] tracking-[.2em] uppercase mb-2">[ USERNAME / EMAIL ]</label><input type="text" id="username" name="username" required class="w-full bg-transparent border border-[#333] px-4 py-3 text-white text-sm font-mono outline-none focus:border-[#CCFF00] no-underline"></div>
            <div><label for="password" class="block text-[10px] font-mono text-[#666] tracking-[.2em] uppercase mb-2">[ PASSWORD ]</label><input type="password" id="password" name="password" required class="w-full bg-transparent border border-[#333] px-4 py-3 text-white text-sm font-mono outline-none focus:border-[#CCFF00] no-underline"></div>
