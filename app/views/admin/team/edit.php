<div class="max-w-4xl mx-auto px-6 lg:px-10 py-10">
    ...
    <form method="POST" action="<?= baseUrl('/admin/team/edit?id=' . (int)$member['id']) ?>" enctype="multipart/form-data" class="space-y-8">
        <div>
        ...
        <div>
            ...
            <?php if (!empty($member['image'])): ?>
                <div class="border border-[#333] p-2 inline-block">
                    <img src="<?= baseUrl('/' . htmlspecialchars($member['image'])) ?>" alt="Current" class="h-32 w-auto grayscale">
                </div>
            <?php else: ?>
