<section class="border-b border-[#333] px-6 lg:px-12 py-20 lg:py-28">
    <div class="max-w-3xl mx-auto">
        <a href="/articles" class="text-[10px] font-mono text-[#666] tracking-[.2em] uppercase hover:text-white no-underline" data-scroll-reveal>[ BACK TO ARTICLES ]</a>
...
<?php if (!empty($article['image'])): ?>
    <section class="border-b border-[#333]">
        <div class="h-48 sm:h-64 lg:h-80 bg-[#111] overflow-hidden">
            <img src="/<?= htmlspecialchars($article['image']) ?>" alt="<?= htmlspecialchars($article['title']) ?>" class="w-full h-full object-cover grayscale opacity-80" loading="lazy">
        </div>
    </section>
<?php endif; ?>
...
<section class="border-b border-[#333] py-12 lg:py-16 text-center px-6">
    ...
    <a href="/articles" class="inline-block px-10 py-3 bg-[#CCFF00] text-[#0a0a0a] font-bold text-sm tracking-[.2em] uppercase font-mono hover:bg-white no-underline" data-scroll-reveal>VIEW ALL ARTICLES</a>
</section>
