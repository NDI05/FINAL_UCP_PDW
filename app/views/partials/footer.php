...
<section class="border-t border-b border-[#333] overflow-hidden py-5 marquee-container">
    <div class="flex" style="white-space:nowrap">
        <div data-marquee class="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#CCFF00] font-display tracking-tight px-4">
            SPEED <span class="text-white mx-6">•</span> SECURITY <span class="text-white mx-6">•</span> SCALABILITY <span class="text-white mx-6">•</span>
            SPEED <span class="text-white mx-6">•</span> SECURITY <span class="text-white mx-6">•</span> SCALABILITY <span class="text-white mx-6">•</span>
        </div>
    </div>
</section>
...
<footer class="border-t border-[#333]">
    <div class="flex flex-col sm:flex-row items-center justify-between px-6 lg:px-12 py-4 text-[10px] font-mono text-[#666] uppercase tracking-wider">
        ...
        <div class="flex gap-6 mt-2 sm:mt-0">
            ...
            <a href="#" class="hover:text-white no-underline">[ INSTAGRAM ]</a>
            <a href="#" class="hover:text-white no-underline">[ LINKEDIN ]</a>
        </div>
    </div>
</footer>
